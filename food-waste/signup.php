...
<head>
    ...
    <style>
        .right {
            background-image: url('cover.jpeg'); /* Specify the background image */
...
<body>
    <div class="container">
        <div class="regform">
            <form action="" method="post">
                ...
                <button type="submit" style="background-color:white; color: #000; margin-top:5px; padding: 10px 25px;">
                    <img src="google.svg" style="width:22px"> Continue With Google 
                </button>  
        ...
        <div class="right"></div> <!-- Background image will be applied here -->
    </div>
