            ...
            <div class="overview">
                ...
                <script>
                    <?php
                        ...
                        $q4="SELECT count(*) as count FROM food_donations WHERE location='Penang'";
                        $res4=mysqli_query($connection, $q4);
                        $ro4=mysqli_fetch_assoc($res4);
                        $penang=$ro4['count'];

                        $q5="SELECT count(*) as count FROM food_donations WHERE location='Johor'";
                        $res5=mysqli_query($connection, $q5);
                        $ro5=mysqli_fetch_assoc($res5);
                        $johor=$ro5['count'];
                    ?>
                    var xValues = ["Male","Female"];
                    var xplace=["Kuala Lumpur","Penang","Johor"];
                    var yplace=[<?php echo json_encode($kualaLumpur,JSON_HEX_TAG);?>,<?php echo json_encode($penang,JSON_HEX_TAG);?>,<?php echo json_encode($johor,JSON_HEX_TAG);?>];
